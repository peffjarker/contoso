...
New-AzResourceGroupDeployment -Mode Incremental -TemplateFile .\Contoso-IT-Spoke\common\dns.bicep -ResourceGroupName 'it-hub-eus2-net-rg' -verbose
...
New-AzResourceGroupDeployment -Mode Incremental -TemplateFile .\Contoso-IT-Hub\agw-modules.bicep -ResourceGroupName 'it-hub-eus2-net-rg' -verbose
